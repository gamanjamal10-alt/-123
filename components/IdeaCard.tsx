...
const IdeaCard: React.FC<{ idea: Idea }> = ({ idea }) => {
  ...
  return (
    <div className="bg-gray-800/50 border border-gray-700 rounded-xl shadow-lg p-6 flex flex-col space-y-5 transition-all duration-300 hover:shadow-blue-500/20 hover:border-blue-500/50 transform hover:-translate-y-1">
